...
public class BulbDeviceGroup {
    ...
    public BulbDeviceGroup sceneEffect(SceneEffect sceneEffect, Color color, Speed speed) {
        BulbCommand bulbCommand = new SceneBulbCommand(sceneEffect, color, speed);
        bulbDevices.forEach(bulbDevice -> bulbDevice.setCommand(bulbCommand));
        return this;
    }
